...
exec(open('submission3/datacode/3_v1996.py').read())
exec(open('submission3/datacode/3_v2010.py').read())
...
# Save final data ---------------------------------------------------------
final_hcris_data.to_csv('data/output/HCRIS_Clean_Data.csv', index=False)